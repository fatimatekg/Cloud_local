...
def get_connection(connection_name):
    ...
    config.read('https://github.com/fatimatekg/Cloud_local/blob/84b72c3832d91e6459ce28ac2c9ef90f36c1a441/cloud%20database.ini')
...
def generate_insert_queries(account_ids, user_id, source_connection_name, target_connection_name):
    try:
        ...
        with open(os.path.expanduser("~/Desktop/SELECT_QUERIES_FINAL.sql"), 'r') as file:
